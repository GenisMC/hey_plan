                    ...
                    child: ElevatedButton(
                        onPressed: () async {
                          if (_controllerDisplayName.text != '' && _controllerDescription.text != '') {
                            //TODO: Make circular indicator not ugly
                            showDialog(
                                context: context,
                                builder: (BuildContext context) => const Dialog(child: CircularProgressIndicator()));
                            ...
                            await singleton.db.addProfileData(singleton.auth.user!.uid, _controllerDescription.text,
